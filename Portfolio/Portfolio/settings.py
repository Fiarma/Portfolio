    ...
    'default': {
        ...
        'stylesSet': [
            # Styles de puces
            {
                'name': 'Puces (Rond)',
                'element': 'ul',
                'attributes': {'style': 'list-style-type: disc;'}
            },
            {
                'name': 'Puces (Carré)',
                'element': 'ul',
                'attributes': {'style': 'list-style-type: square;'}
            },
            {
                'name': 'Puces (Cercle)',
                'element': 'ul',
                'attributes': {'style': 'list-style-type: circle;'}
            },
            # Styles de texte
            {
                'name': 'Gras et rouge',
                'element': 'p',
                'attributes': {'style': 'font-weight: bold; color: red;'}
            },
            {
                'name': 'En-tête de section',
                'element': 'h3',
                'attributes': {'style': 'border-bottom: 2px solid #ccc; padding-bottom: 5px;'}
            }
        ]
    }
}
...
CSRF_TRUSTED_ORIGINS = [
    "https://d5a21ca3418b.ngrok-free.app",  # ton URL ngrok
    "https://www.ton-domaine.com",          # si tu as un domaine officiel
    "https://a43233898717.ngrok-free.app",
    "https://42e196609cef.ngrok-free.app"
]
...
# Correction de la configuration STATIC
STATIC_URL = '/static/'
